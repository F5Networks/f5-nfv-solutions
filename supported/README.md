...
|                           |                                              |                           |
| f5-gilan-plugin 0.2.52    | F5-VNF-Service-Layer-GiLAN_v1.3.X            | inputs_gilan_v1.3.X       |
|                           | vSphere-F5-VNF-Service-Layer-GiLAN_v1.3.X    | inputs_firewall_v1.3.X    |
|                           | F5-VNF-Service-Layer-Firewall_v1.3           | inputs_base_v1.3.X        |
|                           | vSphere-F5-VNF-Service-Layer-Firewall_v1.3.X | inputs_base_v1.3.X        | 
|                           | F5-VNF-Service-Layer-Base_v1.3.X             | inputs_dns_v1.3.1         |
