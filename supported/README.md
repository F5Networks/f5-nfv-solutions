...
|                           |                                              |                           |                                               |                           |                                              |                           |
| f5-gilan-plugin 0.2.53    | F5-VNF-Service-Layer-GiLAN_v1.4.X            | inputs_gilan_v1.4.X       |
|                           | vSphere-F5-VNF-Service-Layer-GiLAN_v1.4.X    | inputs_firewall_v1.4.X    |
|                           | F5-VNF-Service-Layer-Firewall_v1.4.0         | inputs_base_v1.4.X        |
|                           | vSphere-F5-VNF-Service-Layer-Firewall_v1.4.X | inputs_dns_v1.4.X         | 
|                           | F5-VNF-Service-Layer-Base_v1.4.X             |                           |
|                           | F5-VNF-Service-Layer-DNS_v1.4.X              |                           |
|                           |                                              |                           |
...
|                           | F5-VNF-Service-Layer-DNS_v1.3.1              | inputs_dns_v1.3.1.X       |
|                           |                                              |                           |
| f5-ric-plugin 0.5         | F5-VNF-Service-Layer-GiLAN_v1.4.X            | inputs_gilan_v1.4.X       |
|                           | F5-VNF-Service-Layer-Firewall_v1.4.X         | inputs_firewall_v1.4.X    |
|                           | F5-VNF-Service-Layer-Base_v1.4.X             | inputs_base_v1.4.X        |
|                           | F5-VNF-Service-Layer-DNS_v1.4.X              | inputs_dns_v1.4.X         |
|                           |                                              |                           |      
| f5-bigiq-plugin 0.1       | F5-VNF-BIG-IQ_v1.2.1.X                       | inputs_bigiq.yaml_v1.2.1.X |
