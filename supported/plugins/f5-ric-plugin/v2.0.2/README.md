## Use F5 RIC Plugin 2.0.2 
This is the 2.0.2 version of the Resource Information Collector plugin, enabling utility resource collection and usage report generation for the following deployed blueprints:
...
Changes to the F5 RIC plugin include adjusting to meet PEP8 standards. Other changes include support for the following fixes: 
