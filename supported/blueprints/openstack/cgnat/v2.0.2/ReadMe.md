## About the F5-VNF-Service-Layer-CGNAT-Offering_v2.0.2 solution blueprint

This release provides the following fixes ONLY for known issues, and is used with the f5-gilan-plugin_2.0.2 version ONLY.
