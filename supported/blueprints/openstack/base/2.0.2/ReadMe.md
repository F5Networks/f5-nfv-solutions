## About the F5-VNF-Service-Layer-Base_v2.0.2 solution blueprint

This release provides the following fixes for known issues and preview functionlality changes. Use with the f5-gilan-plugin_0.2.0.2 version ONLY: 
